...
username_field = driver.find_element(By.XPATH, "//html/body/form/input[@id='username']")
password_field = driver.find_element(By.XPATH, "//input[@id='password']")
login_button = driver.find_element(By.XPATH, "//button[@id='login_button']")

# Знаходження елемента за CSS класом
username_field = driver.find_element(By.CSS_SELECTOR, ".input-field#username")
password_field = driver.find_element(By.CSS_SELECTOR, ".input-field#password")
